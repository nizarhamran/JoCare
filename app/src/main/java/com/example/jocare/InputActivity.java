...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReBackBtn = findViewById(R.id.ReminderBack);
        Intent fabIntent =getIntent();
        String InpID = fabIntent.getStringExtra("InpID");
        ReBackBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backIntent= new Intent(InputActivity.this,MedicationReminder.class);
                backIntent.putExtra("medId",InpID);
        ...
        btn_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cancelIntent.putExtra("medId",InpID);
        ...
        reminderDb =database.getReference("Users").child(InpID).child("Reminder");
