    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserInfo.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        ViewFname.setText(f.substring(0,1).toUpperCase()+f.substring(1));
                        ViewLname.setText(l.substring(0,1).toUpperCase()+l.substring(1));
                        ViewNatID.setText(nat);
                        ViewDob.setText(dob);
                        ViewCity.setText(city.substring(0,1).toUpperCase()+city.substring(1));
                        ViewPhone.setText(phone);
                        ViewPo.setText(postal);
                        ViewAddress.setText(address.toUpperCase());
